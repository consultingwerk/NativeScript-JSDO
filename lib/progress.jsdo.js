...
(function () {
    ...
    progress.data.AuthenticationProvider.prototype._openRequestAndAuthorize = function (xhr,
                                                                                        ...
                                                                                        callback) {
        var errorObject;
        // Radu Nicoara 19.07.2017
        // Open the XHR request regardless of what the hasValidCredentials method returns
        // (moved xhr.open call outside the if clause)
        // NOTE: this is a temporary workaround; the hasClientCredentials method seems to 
        // always return false even after a successful login, causing some requests to throw
        // an XHR InvalidStateError
        xhr.open(verb, uri, async);
